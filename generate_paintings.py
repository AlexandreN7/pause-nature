...
def createPic(deviations, foFILE, templatePath):
    imageNb = 0
...
def gene_pic_gallery():
    ...
    for line in foFILEout:
        ...
        if (re.search("start autogenerated", line)):
            copy = 0    
            createPic(deviations, foFILE, templatePath)
      
    os.system("mv "+templatePath+"/htmlfile.txt "+templatePath+"/galerie_peinture.html")
