...
def createPic(imgList, foFILE, templatePath):
    for pages in range(len(imgList)):
        ...
        for imageNb in range(totalhits) :
            foFILE.write("     <input class=\"gallery__select\"  type=\"radio\" name=\"autogenerated\" id=\""+str(imageNb+pages*200)+"\"/>\n")
        ...
        for imageNb in range(totalhits) :
            ...
            name = re.sub(r'(.*)?\/', '', name)
            foFILE.write("         <label class=\"gallery__item\" for=\""+str(imageNb+pages*200)+"\">\n")
...
def gene_pic_gallery():
    ...
    for line in foFILEout:
        ...
        if (re.search("start autogenerated", line)):
            ...
            createPicInsect(imgList, foFILEInsect, templatePath)
            createPicLiving(imgList, foFILELiving, templatePath)
            createPicGiverny(imgList, foFILEGiverny, templatePath)
            createPicMoutain(imgList, foFILEMountain, templatePath)
            createPicFlower(imgList, foFILEFlower, templatePath)
