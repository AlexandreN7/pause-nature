...
def autoHTML (name, link, alt, templatePath, pageURL):
    ...
    foFILE_sheet.write("            </div>\n")
    foFILE_sheet.write("\n")
    foFILE_sheet.write("        </div> <!-- End div pure blabla -->\n")
    foFILE_sheet.write("\n")
