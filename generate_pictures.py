...
def autoHTML (name, link, alt, templatePath, pageURL):
    ...
    foFILE_sheet.write("                            <a class=\"pure-button\" href=\"/home\">Page principale</a>\n")
    foFILE_sheet.write("                        </li>\n")
    foFILE_sheet.write("                        <li class=\"nav-item\">\n")
    foFILE_sheet.write("                            <a class=\"pure-button\" href=\"/reviews\">Articles et revues</a>\n")
    foFILE_sheet.write("                        </li>\n")
    foFILE_sheet.write("                        <li class=\"nav-item\">\n")
    foFILE_sheet.write("                            <a class=\"pure-button\" href=\"/galerie_peinture\">Peintures</a>\n")
    foFILE_sheet.write("                        </li>\n")
    foFILE_sheet.write("                        <li class=\"nav-item\">\n")
    foFILE_sheet.write("                            <a class=\"pure-button\" href=\"/galerie_pictures\">Photos</a>\n")
    foFILE_sheet.write("                        </li>\n")
    foFILE_sheet.write("                        <li class=\"nav-item\">\n")
...
def createPic(imgList, templatePath, pagesList, imagePerPage):
    ...
    for deviation in imgList :
        ...
        pagesList[borderCount]["foFILE"].write("             <a href=\"/sheet-pictures-"+str(name)+"\" target=\"_blank\">\n")
